...
- Use Python to create data visualizations, and manipulate data to enable good visualizations
-	Understand and appropriately use color, symbols and small multiples
-	Create static and dynamic data visualizations
...
There will be office hours via Zoom on Thursdays, 7:00-8:30 pm
...
Assignment submission is through Canvas. 
