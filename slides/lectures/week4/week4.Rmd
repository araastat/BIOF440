...
<iframe
    width="100%"
    height="500"
    src="week4_files/alt_facet6.html"
    frameborder="0"
    allowfullscreen
></iframe>
...
```
    ...
    [NbConvertApp] Converting notebook week4.ipynb to markdown
    [NbConvertApp] Writing 51884 bytes to week4.md
...
```
    ...
    [NbConvertApp] Converting notebook week4.ipynb to html
    [NbConvertApp] Writing 847721 bytes to week4.html
